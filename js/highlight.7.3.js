...
hljs.LANGUAGES.bash = function (a) {
    ...
    return {
        ...
        c: [{
            ...
            b: "(#!\\/bin\\/bash)|(#!\\/bin\\/sh)",
            r: 10
        }, c, b, a.HCM, h, d, a.inherit(f, {b: "\\[ ", e: " \\]", r: 0}), a.inherit(f, {
            b: "\\[\\[ ",
            e: " \\]\\]"
        })]
    }
...
hljs.LANGUAGES.xml = function (a) {
    ...
    return {
        ...
        }, {b: "", sL: "vbscript"}, {cN: "tag", b: "</?", e: "/?>", c: [{cN: "title", b: "[^ />]+"}, b]}]
    }
}(hljs);
...
hljs.LANGUAGES.vala = function (a) {
    return {
        ...
        c: [{
            ...
            c: [{bWK: true, k: "extends implements"}, {cN: "title", b: a.UIR}]
