...
V původních pravidlech [je zmíněno](https://pph.drdplus.info/?version=1.0&trial=1#akce), že se na akci dá připravit a hráč si pak může hodit kostkami dvakrát a vybrat ten lepší hod:
...
V našem návrhu na *Úhyb* naopak kostkou nehážeme vůbec a nechceme za *Úhyb* ani žádné body *Boje*, čímž děláme z *Úhybu* [**automatickou** činnost](https://pph.drdplus.info/?version=1.0&trial=1#automaticka_cinnost).
...
Hmm, to ale hod na *náhodu* supluje vlastně [*velikost pasti*](https://pph.drdplus.info/?version=1.0&trial=1#zakladni_hod_na_uspech), proti které si houbař a noční hlídač hází, ne?
Ne, [*velikost pasti*](https://pph.drdplus.info/?version=1.0&trial=1#zakladni_hod_na_uspech) si musí Pán jeskyně zvolit tak jako tak, hod na *náhodu* mu jenom pomáhá řešit proměnlivost světa, aniž by u toho musel příliš přemýšlet. A je samozřejmě na Pánovi jeskyně, jestli chce hod na *štěstí* a přičte ho hrdinovi k dobru, čímž vlastně sníží past, nebo na *smůlu* a... no vždyť víš.
...
S tím souhlasíme, přesto chceme *Úhyb* omezit. Vysvětlíme blíže *proč* a nastíníme plány se [Zlodějem](https://zlodej.drdplus.info/?version=1.0&trial=1) a obecně i s dalšími povoláními.
...
- náš [*Bijec*](https://bojovnik.drdplus.info/?version=1.0&trial=1#bijec) se naprosto neobtěžoval se bránit, protože jeho [řemdih](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_zbrani_obourucni_zbrane) s *Krytem* 2 by mu celkovou *Obranu* zvýšil **jen** o ty dva body, navíc ([podle původních pravidel](https://pph.drdplus.info/?version=1.0&trial=1#volba_obrany_proti_utoku_zblizka)) by mu *Obrana* sebrala akci, pokud by nebyl rychlejší než útočník, a ještě k tomu pořeboval být náš *Bijec* stále zraněný, aby byl [pod parou](https://bojovnik.drdplus.info/?version=1.0&trial=1#pozehnani_bolesti_i)
- náš čaroděj nám oznámil, že jestli *Bijec* nepřijde o svou akci útoku, když se brání pouhým *Úhybem* a když už *Bijce* někdo během *Úhybu* zraní, tak za to nemá žádný postih, tak on teda taky chce *Úhyb* bez postihu a s žádným [soustředěním za extrémních podmínek](https://pph.drdplus.info/?version=1.0&trial=1#soustredeni_za_extremnich_podminek) ať na něj nechodíme
...
- fintu [Odskočení](https://zlodej.drdplus.info/?version=1.0&trial=1#odskoceni), kterou se zloděj dostane z dosahu nepřítele, když mu teče do bot
...
- až na tu fintu, která nám připomíná, že ještě budeme muset řešit [*Převahu*](https://pph.drdplus.info/?version=1.0&trial=1#shrnuti_kola_boje), která je po změnách s body *Boje* poněkud nefunkční
...
- *následující [>> 3. 10. 2018 Co chcete?](2018-10-03-co_chcete.md)*
