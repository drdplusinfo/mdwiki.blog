...
S tím souhlasíme. Vysvětlíme proto blíže, proč *Úhyb* chceme měnit a nastíníme plány se [Zlodějem](https://zlodej.drdplus.info) a obecně i s dalšími povoláními.

*Úhyb* je v současnosti silný u **každého**, nejenom u zloděje, pouze nám *Velký fanoušek* pomohl rozpomenout se na naše herní situace, kdy:

- náš [*Bijec*](http://bojovnik.drdplus.loc:88/#bijec) se naprosto neobtěžoval se bránit, protože jeho [řemdih](https://pph.drdplus.info/#tabulka_zbrani_obourucni_zbrane) s *Krytem* 2 by mu celkovou *Obranu* zvýšil **jen** o ty dva body, navíc ([podle původních pravidel](https://pph.drdplus.info/#volba_obrany_proti_utoku_zblizka)) by mu *Obrana* sebrala akci, pokud by nebyl rychlejší než útočník, a ještě k tomu pořeboval náš *Bijec* být stále zraněný, aby byl [pod parou](https://bojovnik.drdplus.info/#pozehnani_bolesti_i)
- náš čaroděj nám oznámil, že jestli *Bijec* nepřijde o svou akci útoku, když se brání pouhým *Úhybem* a když už ho někdo během *Úhybu* zraní, tak za to nemá žádný postih, tak on teda taky chce *Úhyb* bez postihu a s žádným [soustředěním za extrémních podmínek](http://pph.drdplus.loc:88/#soustredeni_za_extremnich_podminek) ať na něj nechodíme
    - s tím jsme souhlasili, *když rovnoprávnost, tak pro všechny*, ale přestalo se to líbit hráčům ve chvíli, kdy ani nepřátelé netrpěli zásahy při čarování (holt *když rovnoprávnost, tak pro všechny*)
...
Větřili jsme, že s *Úhybem* je něco v něpořádku, ale nedokázali jsme se kvůli *moci psaných pravidel* navzájem rozhoupat k větší změně. K takové změně, která by všem bez rozdílu dala *Úhyb* jako poslední, **zoufalou** možnost obrany.
...
- běžnou *Obrana* je hod kostkou (pro každého stejné), k tomu *Zbroj* (u zloděje slabší), k tomu *Obratnost* (u zloděje vyšší)
- fintu [Odskočení](https://zlodej.drdplus.info/#odskoceni), kterou se zloděj dostane z dosahu nepřítele, když mu teče do bot
- díky vyšší *Obratnosti* má zloděj vyšší *Boj*, který bude moci [mimo jiné](2018-08-10-boj.md) použít na lepší *Obranu*

Není to špatné, zejména více možností díky vyššímu *Boji* je velká výhoda, ale většinou to jsou samé obecné schopnosti, které má každý, až na tu fintu (která nám připomíná, že ještě budeme muset řešit [*Převahu*](http://pph.drdplus.loc:88/#shrnuti_kola_boje), která je po změnách s body *Boje* poněkud nefunkční). Zloději tedy po oslabení *Úhybu* chybí schopnost zůstat nezraněn, nebo si alespoň zvýšit šance, že to tak bude.

Jak by toho mohl zloděj dosáhnout? Co to vlastně je *být zloděj*?
...
To co nám v pravidlech pro zloděje nyní chybí, to je způsob, jakým zloděj bude získávat výhody na úkor sebejistoty ostaních, ať už to budou klamné výpady, herectví (ikdyž [Neškodný vzhled](http://zlodej.drdplus.loc:88/#neskodny_vzhled) je dobrý základ), písek a jiné nepříjemnosti vržené do citlivých míst a podobné špinavé triky, které zvyšují šanci na přežití.
Zatím jsme o tom hluboce nepřemýšleli, zatím nás napadlo jen, že za různé zlodějské finty bude "platit" *Bojem* a bude možné jich skládat více za sebou, čímž se bude zvyšovat riziko odhalení podvodu, ale když se to povede, tak to bude pecka.

A to bude platit i na zlodějské schopnosti obrany a úniku, které **nebudou** automatické (což *Únik* v původních pravidlech je), a zloděj bude moci díky nim protancovat mezi nepřáteli a cestou rozdat pár autogramů.
...
Pokud to zloději dovolí, tak ať tleskají, ale obecně chceme snížit počet automatických činností (jakou je třeba hraničářova [Ostražitost](http://hranicar.drdplus.loc:88/#ostrazitost_stupen_znalosti_1)), a zvýšit možnosti a tím kombinace, ať už v boji či mimo něj, které budou moci **hráči** vědomě používat. Jen na to potřebujeme bytelný základ, abychom nezaváděli pro každé povolání jiné zdroje. Pro boj máme body *Boje*, uvidíme, co nám vykrystalizuje pro činnosti mimo boj.
