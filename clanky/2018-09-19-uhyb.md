...
S tím souhlasíme, přesto chceme *Úhyb* omezit. Vysvětlíme blíže *proč* a nastíníme plány se [Zlodějem](https://zlodej.drdplus.info/?version=1.0) a obecně i s dalšími povoláními.
...
- náš [*Bijec*](https://bojovnik.drdplus.info/?version=1.0#bijec) se naprosto neobtěžoval se bránit, protože jeho [řemdih](https://pph.drdplus.info/?version=1.0#tabulka_zbrani_obourucni_zbrane) s *Krytem* 2 by mu celkovou *Obranu* zvýšil **jen** o ty dva body, navíc ([podle původních pravidel](https://pph.drdplus.info/?version=1.0#volba_obrany_proti_utoku_zblizka)) by mu *Obrana* sebrala akci, pokud by nebyl rychlejší než útočník, a ještě k tomu pořeboval náš *Bijec* být stále zraněný, aby byl [pod parou](https://bojovnik.drdplus.info/?version=1.0#pozehnani_bolesti_i)
- náš čaroděj nám oznámil, že jestli *Bijec* nepřijde o svou akci útoku, když se brání pouhým *Úhybem* a když už *Bijce* někdo během *Úhybu* zraní, tak za to nemá žádný postih, tak on teda taky chce *Úhyb* bez postihu a s žádným [soustředěním za extrémních podmínek](https://pph.drdplus.info/?version=1.0#soustredeni_za_extremnich_podminek) ať na něj nechodíme
...
- fintu [Odskočení](https://zlodej.drdplus.info/?version=1.0#odskoceni), kterou se zloděj dostane z dosahu nepřítele, když mu teče do bot
- díky vyšší *Obratnosti* vyšší *Boj*, který bude moci zloděj [mimo jiné](2018-08-10-boj.md) použít na lepší *Obranu*

Není to špatné, zejména více možností díky vyššímu *Boji* je velká výhoda, ale většinou to jsou samé obecné schopnosti, které má každý, až na tu fintu (která nám připomíná, že ještě budeme muset řešit [*Převahu*](https://pph.drdplus.info/?version=1.0#shrnuti_kola_boje), která je po změnách s body *Boje* poněkud nefunkční). Zloději tedy po oslabení *Úhybu* chybí schopnost zůstat nezraněn, nebo si alespoň zvýšit šance, že to tak bude.
...
Pokud to zloději dovolí, tak ať tleskají, ale obecně chceme snížit počet automatických činností (jakou je třeba hraničářova [Ostražitost](https://hranicar.drdplus.info/?version=1.0#ostrazitost_stupen_znalosti_1)), a zvýšit možnosti a tím kombinace, ať už v boji či mimo něj, které budou moci **hráči** vědomě používat. Jen na to potřebujeme bytelný základ, abychom nezaváděli pro každé povolání jiné zdroje. Pro boj máme body *Boje*, uvidíme, co nám vykrystalizuje pro činnosti mimo boj.
