...
Ve všech našich chlapsky romantických představách proklaje udatný ochránce slabších tři nenapravitelné záporáky během chviličky, kdežto při hře si hodíme každé kolo jednou na *Boj*, když máme štěstí tak jednou na útok (protože když na nás záporák [zaútočí první a my se mu radši bráníme zbraní, tak ten útok ztratíme](https://pph.drdplus.info/?version=1.0&trial=1#volba_obrany_proti_utoku_zblizka)) a pak jednou na obranu. Toť vše, nic moc.
...
Když si vezmeme původní pravidla, tak body *Boje* ovlivňují nějaké ty [základní vlastnosti](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_boje), k tomu hod 2k6± a pak spousta úprav jako [dovednost se zbraní](https://pph.drdplus.info/?version=1.0&trial=1#boj_se_zbrani), [únava](https://pph.drdplus.info/?version=1.0&trial=1#postih_za_unavu) a [zranění](https://pph.drdplus.info/?version=1.0&trial=1#postih_za_zraneni), [terén](https://bojovnik.drdplus.info/?version=1.0&trial=1#boj_v_terenu_i) a tak.
...
- [bonus +6 znamená dvojnásobek a "bonus" -6 polovičku](https://pph.drdplus.info/?version=1.0&trial=1#scitani_a_odcitani)
- zatraceně [mizerný úlovek](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_ulovku) dává postih k odpočinku -6 (ne, to ještě není schválená změna),
...
Za každý jeden stupeň [dovednosti Boje s typem zbraně](https://pph.drdplus.info/?version=1.0&trial=1#boj_se_zbrani) pěkně bonus +1 ke všemu bojovému, tedy +1 k *Boji*, +1 k *Útoku*, +1 k *Obraně* a nazdar.
...
Jenže krom bonusů jsou tu stále i postihy. Postih za [nedostatečnou sílu](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_postihu_ke_zbrani_za_chybejici_silu) (kterou chceme zjednodušit na -1 ke všemu k boji za každý chybějící bod *Síly*), [postih za únavu](https://pph.drdplus.info/?version=1.0&trial=1#postih_za_unavu) a [zranění](https://pph.drdplus.info/?version=1.0&trial=1#postih_za_zraneni) a určitě by se ještě [něco našlo](https://pph.drdplus.info/?version=1.0&trial=1#postizeni).
...
U toho jsme vyšli z původního [rozdělení činností](https://pph.drdplus.info/?version=1.0&trial=1#cinnosti_a_koncentrace) podle duševní náročnosti na *automatické*, s *volným soustředěním*, *plným soustředěním* a *transem* (a tohle rozdělení zachováme).

- [trans](https://pph.drdplus.info/?version=1.0&trial=1#trans) zabere celé kolo, pokud není výslovně uvedeno jinak
...
- činnost [s plným soustředěním](https://pph.drdplus.info/?version=1.0&trial=1#plne_soustredeni) zabere 6 bodů *Boje*
  - útok
...
- činnost [s volným soustředěním](https://pph.drdplus.info/?version=1.0&trial=1#volne_soustredeni) zabere 3 body *Boje*
  - mluvení
  - rychlé přezbrojení (zahození původní zbraně a připravení nové)
  - vytažení předmětu z kapsy
- [automatická činnost](https://pph.drdplus.info/?version=1.0&trial=1#automaticka_cinnost) nezabere nic
...
Poznámka: v současných pravidlech se uvádí, že když provádíš dvě akce s *volným soustředěním* zároveň, tak k nim máš [postih -3](https://pph.drdplus.info/?version=1.0&trial=1#volne_soustredeni). To s novými pravidly o bodech *Boje* odpadá - pokud na dvě akce s volným soustředěním body *Boje* máš, tak se žádný postih nekoná.
...
V [Pravidlech pro hráče](https://pph.drdplus.info/?version=1.0&trial=1#dalsi_bojove_akce) jsou tyto zvláštní bojové akce, u kterých přemýšlíme o zrušení, protože je zvládneš přeléváním bodů *Boje*:

  - *[Bezhlavý útok](https://pph.drdplus.info/?version=1.0&trial=1#bezhlavy_utok): +2 k Útočnému číslu, +2 k Základu zranění, -5 k obraně*
    - podobného výsledku dosáhneš, když ze své akce *Obrana* odebereš dva body *Boje* a máš tak postih -2 k obraně a tyto body *Boje* si přidáš k akci *Útok*, takže získáš bonus +2 k *Útoku*
      ...
      - druhá poznámka: plánujeme sloučit *Obranné číslo* a *Ochranu zbroje* do jediného čísla *Obrana*
        - například *Obranost* +4 a pobíjená zbroj s *Ochranou zbroje* +3 dají *Obranu* 7
          - také už víme, že chybějící *Síla* bude rovnou výsledný postih k *Obraně* (respektive ke všemu), žádná tabulka, ale ještě nevíme, jestli dovednost [Nošení zbroje](https://pph.drdplus.info/?version=1.0&trial=1#noseni_zbroje) bude snižovat postih, jakkoli to zní logicky, nebo zvyšovat bonus, podobně jako to **bude** u dovednosti [Boje se zbraní](https://pph.drdplus.info/?version=1.0&trial=1#boj_se_zbrani))
  - *[Soustředění na obranu](https://pph.drdplus.info/?version=1.0&trial=1#soustredeni_na_obranu): +2 k BČ a +2 k OČ, ale nemůžeš v tomto kole útočit*
  ...
  - *[Krytí spolubojovníka](https://pph.drdplus.info/?version=1.0&trial=1#kryti_spolubojovnika): ...Bohužel ochránce nemá v tomto kole možnost provést vlastní útok.*
  ...
  - *[Mířená střelba](https://pph.drdplus.info/?version=1.0&trial=1#mirena_strelba) - Za každé kolo míření s postihem −2 k BČ si přičte +1 k ÚČ. Celkově může postava mířením získat bonus +3 k ÚČ.*
...
Přestože pravidla řeší [Rychlost](https://pph.drdplus.info/?version=1.0&trial=1#rychlost) (coby kombinaci *Síly* a *Obratnosti*), tak v boji je tenhle údaj prakticky nepoužitelný, protože je to *stálá* rychlost ve víceméně *neměnném* prostředí, což se rozhodně nedá říct o boji, kde ti kdekdo chce podrazit nohy, bodnout tě do zad, vypálit do hrudi flek jak ze zapomenuté žehličky a tak všelijak podobně. Rychlost, tak jak je [uvedená v pravidlech pro hráče](https://pph.drdplus.info/?version=1.0&trial=1#rychlost), se dá použít **až** když se vymaníš z boje (většina z nás tomu říká útěk, někteří třeba teleport).
...
## Překvapení
Pokud se ti podaří někoho překvapit, máš celé kolo pro sebe. Vážně? No, [podle původních pravidel ano](https://pph.drdplus.info/?version=1.0&trial=1#prekvapeni), což je tak akorát, protože tím překvapený přijde o jednu akci (respektive se může pouze bránit tím, co má zrovna po ruce).
...
Ovšem pokud máš v ruce třeba [dlouhou dýku](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_zbrani_jednorucni_zbrane) s délkou 1, tak... tak nic, protože to není délka v metrech, ale v "půlmetrech", takže ti dáme do ruky radši kopí s délkou čtyři, což jsou dva metry a najednou bys lučištníka po doběhnutí už devíti metrů zase mohl poškádlit (z devíti metrů už se zbraní s dosahem dvou metrů dosáhneš na lučištníkův jedenáctý metr), byť s postihem k Útoku -6, jelikož ti došly body *Boje*.

Tím jsme se dostali k délce zbraně, která podle původních pravidel [přidává bonus k *Boji*](https://pph.drdplus.info/?version=1.0&trial=1#delka_zbrane). Inu, v původních pravidlech proč ne, útok podle nich máš stejně jeden za kolo, takže útočit budeš pouze tou zbraní, kterou jsi na začátku popadnul.
...
Proto chceme délku zbraně jako bonus k *Boji* **zrušit**, [délky zbraní](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_zbrani_jednorucni_zbrane) upravit na metry (prostě původní zmenšíme na polovic) a délku zbraně tak využiješ pouze při útoku, aby sis zvýšil dosah a **ušetřil** nějaké body *Boje*.
...
V Pravidlech pro hráče má [každé povolání jiný základ *Boje*](https://pph.drdplus.info/?version=1.0&trial=1#tabulka_boje).
...
- za *Obratnost*?
  - **ano**, je to souhrn instinktů, schopnost reagovat na nenadálé situace
    - ještě přemýšlíme o *Smyslech* jako základu boje, což by ale silně narušil zloděj se svými [Zdokonalenými smysly](https://zlodej.drdplus.info/?version=1.0&trial=1#zdokonalene_smysly)
- za *Zručnost*?
...
V původních pravidlech [ovlivňuje *Výška* postavy její *Boj*](https://pph.drdplus.info/?version=1.0&trial=1#oprava_boje_za_vysku). Přemýšleli jsme, co tím chtěl básník říci a vyšlo nám, že i my s tím pocitově souhlasíme, protože přece dlouhá ruka velkýho chlapa dříve trefí hlavu zákrska, než obráceně.
...
Když už jsme u té velikosti, rozlouskneme ještě jednu situaci, ve které se [*Velikost* počítá a to šance na zásah zbraní na dálku](https://pph.drdplus.info/?version=1.0&trial=1#oprava_za_velikost).
...
- body *Boje* mohu mezi akcemi přesouvat, ale pouze na začátku každé *vlny akcí*
    - za každý bod *Boje* navíc, kterou na akci použiju, dostanu k této akci bonus +1 (ať už je to cokoliv, útok, obrana, kouzlení, zastrašování, [hraní bezbranného](https://zlodej.drdplus.info/?version=1.0&trial=1#neskodny_vzhled)...)
...
- "zadarmo" se můžu kdykoli dát do běhu plnou [Rychlostí](https://pph.drdplus.info/?version=1.0&trial=1#rychlost_pohybu) (útěk, pronásledování), ale u takového pohybu mám -6 ke všem činnostem od "teď" do konce tohoto kola (ztratím kontakt s bojem)
