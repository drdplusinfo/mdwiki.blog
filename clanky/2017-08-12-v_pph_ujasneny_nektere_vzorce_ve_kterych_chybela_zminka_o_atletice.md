...
V [PPH, Pravidlech pro hráče](https://pph.drdplus.info/?version=1.0) jsem našel několik nesrovnalostí a chybějících údajů, které jsem v průběhu opravil:
...
> [Maximální náklad = Sil + 21 [+ Atletika]](https://pph.drdplus.info/?version=1.0#vypocet_maximalniho_nakladu)

by vzorec měl upozorňovat na bonus z atletiky.

Vzorec pro Pohybovou rychlost jsem tedy rozšířil
> [Pohybová rychlost = Rch/2 + bonus podle druhu pohybu [+ Atletika při běhu a sprintu]](https://pph.drdplus.info/?version=1.0#vypocet_pohybove_rychlosti)
...
> [Délka (výška) skoku = Rch/2 + bonus + 1k6 [+ Atletika]](https://pph.drdplus.info/?version=1.0#vypocet_delky_a_vysky_skoku)
...
> [Body zranění = τ(Síla zranění) − τ(Obr [+ Atletika])](https://pph.drdplus.info/?version=1.0#vypocet_zraneni_pri_padu)
