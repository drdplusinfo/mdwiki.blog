...
- akce lze stále omezovat pro posílení jiných a posilovat na úkor jiných a toto přelévání energie mezi akcemi omezuje *Zručnost*
    ...
    - navíc už přelévání energie mezi akcemi ve stejném **kole** dostává na frak právě kvůli [jinému přístupu k vlastnostem](2018-10-22-nula.md) a tím výslednému počtu akcí
